...
<body class="flex items-center justify-center min-h-screen px-4">
    ...
    <div class="container-auth bg-white rounded-[20px] shadow-2xl relative" id="container">
        ...
        <div class="form-container sign-up-container">
            <form action="<?php echo e(route('register')); ?>" method="POST" class="bg-white flex flex-col items-center justify-center h-full px-10 text-center">
                <?php echo csrf_field(); ?>
        ...
        <div class="form-container sign-in-container">
            <form action="<?php echo e(route('login')); ?>" method="POST" id="signInForm" class="bg-white flex flex-col items-center justify-center h-full px-10 text-center">
                <?php echo csrf_field(); ?>    
...
</html><?php /**PATH C:\laragon\www\UAS\resources\views/auth.blade.php ENDPATH**/ ?>