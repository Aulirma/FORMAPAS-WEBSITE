...
<body class="p-6 bg-[#FFF4E6]">
    ...
    <div class="flex justify-between items-center mb-8 bg-white p-6 rounded-2xl shadow-sm">
        <div>
            ...
            <p class="text-gray-500">
                Selamat datang, <?php echo e($admin->ADMIN_NAME); ?>!
            </p>
        </div>

        <div class="flex items-center gap-4">
            <a href="<?php echo e(route('admin.pengurus.index')); ?>" 
            ...
            <form id="logout-form" action="<?php echo e(route('admin.logout')); ?>" method="POST" class="inline">
                <?php echo csrf_field(); ?>
    ...
    <div class="mb-10 bg-white p-6 rounded-2xl shadow-sm border-l-4 border-[#db5400]">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="text-sm text-blue-600 hover:underline">Lihat Semua Pesanan &rarr;</a>
        </div>
            ...
            <table class="w-full text-sm text-left text-gray-500">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b hover:bg-gray-50">
                        <td class="px-4 py-3 font-bold text-gray-900"><?php echo e($order->trx_id); ?></td>
                        <td class="px-4 py-3">
                            <div class="font-semibold"><?php echo e($order->nama_penerima); ?></div>
                        ...
                        <td class="px-4 py-3 text-center flex justify-center gap-2">
                            <form action="<?php echo e(route('admin.orders.approve', $order->trx_id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                            ...
                            <button onclick="tolakPesanan('<?php echo e($order->trx_id); ?>')" 
                                    class="bg-red-500 text-white px-3 py-1.5 rounded hover:bg-red-600 transition flex items-center gap-1">
                                <i class="fa-solid fa-xmark"></i> Tolak
                            </button>

                            <form id="form-tolak-<?php echo e($order->trx_id); ?>" 
                                  action="<?php echo e(route('admin.orders.reject', $order->trx_id)); ?>" 
                                  method="POST" style="display: none;">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="alasan" id="alasan-<?php echo e($order->trx_id); ?>">
                            </form>
                        </td>
                    </tr>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $pendaftar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border-b hover:bg-orange-50 transition">
                            ...
                            <td class="p-3"><?php echo e($p->universitas); ?></td>
                            ...
                            <td class="p-3 text-center">
                                <?php if($p->status === 'menunggu'): ?>
                                    <div class="flex justify-center gap-1">
                                        <form method="POST" action="<?php echo e(route('admin.kkn.approve', $p->id)); ?>">
                                            <?php echo csrf_field(); ?>
                                            <button class="bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded text-xs">Setuju</button>
                                        </form>
                                        <form method="POST" action="<?php echo e(route('admin.kkn.reject', $p->id)); ?>">
                                            <?php echo csrf_field(); ?>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="text-gray-700 text-sm">
                    <?php $__empty_1 = true; $__currentLoopData = $seleksi_pending; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="border-b border-gray-50 hover:bg-gray-50 transition">
                        <td class="py-4">
                            <div class="font-bold text-gray-800"><?php echo e($s->nama_lengkap ?? $s->user->USER_NAME); ?></div>
                            <div class="text-xs text-gray-500">NIK: <?php echo e($s->nik); ?></div>
                        </td>
                        <td class="py-4">
                            <?php if($s->status_tahap_1 == 'menunggu'): ?>
                                <span class="px-3 py-1 rounded-full text-xs font-bold bg-orange-100 text-orange-700">
                                    Menunggu Tahap 1
                                </span>
                            <?php elseif($s->status_tahap_2 == 'menunggu'): ?>
                                <span class="px-3 py-1 rounded-full text-xs font-bold bg-blue-100 text-blue-700">
                                    Menunggu Tahap 2
                                </span>
                            <?php elseif($s->sudah_wawancara && $s->status_final == 'menunggu'): ?>
                        ...
                        <td class="py-4">
                            ...
                            <?php elseif($s->status_tahap_2 == 'menunggu'): ?>
                                <div class="text-gray-600 truncate max-w-xs" title="<?php echo e($s->judul_essay); ?>">
                                    Essay: "<?php echo e($s->judul_essay); ?>"
                                </div>
                            <?php else: ?>
                        ...
                        <td class="py-4 flex justify-center gap-2">
                            <form action="<?php echo e(route('admin.seleksi.update', $s->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                            ...
                            <form action="<?php echo e(route('admin.seleksi.update', $s->id)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menolak peserta ini?');">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <ul class="space-y-3">
                    <?php $__empty_1 = true; $__currentLoopData = $latestNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li class="border-b pb-2 text-sm text-gray-700 truncate">
                            ...
                            <?php echo e($n->JUDUL_NEWS); ?>

                            <div class="text-xs text-gray-400 ml-4"><?php echo e($n->created_at); ?></div>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col border-t-4 border-[#db5400]">
            <div class="p-6 flex justify-between items-center bg-orange-50">
                ...
                <a href="<?php echo e(route('formapals')); ?>" class="bg-[#db5400] text-white px-4 py-1 rounded text-sm font-bold hover:bg-[#b04300] shadow-md">
                    Cek User →
                </a>
            </div>
            <div class="p-4 flex-1">
                <ul class="space-y-3">
                    <?php $__empty_1 = true; $__currentLoopData = $latestUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li class="border-b pb-2 text-sm text-gray-700">
                            <span class="text-orange-500 font-bold mr-2">•</span> <?php echo e($u->USER_NAME); ?>

                            <div class="text-xs text-gray-400 ml-4"><?php echo e($u->USER_EMAIL); ?></div>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <li class="text-gray-400 text-sm">Tidak ada data.</li>
                    <?php endif; ?>
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col border-t-4 border-green-500">
            <div class="p-6 flex justify-between items-center bg-green-50">
                ...
                <a href="<?php echo e(route('admin.merch')); ?>" class="bg-green-600 text-white px-4 py-1 rounded text-sm font-bold hover:bg-green-700 shadow-md">
                    Edit Merch →
                </a>
            </div>
            <div class="p-4 flex-1">
                <ul class="space-y-3">
                    <?php $__empty_1 = true; $__currentLoopData = $latestMerch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li class="border-b pb-2 text-sm text-gray-700 flex justify-between">
                            <div class="truncate w-2/3">
                                <span class="text-green-500 font-bold mr-2">•</span> <?php echo e($m->NAMA_PRODUCT); ?>

                            </div>
                            <span class="text-xs font-bold text-green-700">Rp <?php echo e(number_format($m->HARGA_PRODUCT,0,',','.')); ?></span>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <li class="text-gray-400 text-sm">Tidak ada data.</li>
                    <?php endif; ?>
...
</html><?php /**PATH C:\laragon\www\UAS\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>