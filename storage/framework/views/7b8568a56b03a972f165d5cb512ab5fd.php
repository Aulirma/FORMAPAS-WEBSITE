  ...
  <section class="pt-24 pb-16">
    <div class="container px-6 py-10 mx-auto">
        ...
        <div id="content-bph" class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3 team-content">
            <?php $__currentLoopData = $bph; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex flex-col items-center">
                <img class="object-cover w-full rounded-xl aspect-square shadow-md" 
                    src="<?php echo e(asset('storage/' . $p->image)); ?>" 
                    alt="<?php echo e($p->name); ?>">
                
                <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize"><?php echo e($p->name); ?></h1>
                <p class="mt-2 text-gray-500 capitalize"><?php echo e($p->position); ?></p>
                <div class="flex items-center justify-center gap-4 mt-4">
                    
                    <?php if($p->whatsapp): ?>
                        <a href="<?php echo e($p->whatsapp); ?>" target="_blank" class="text-gray-400 hover:text-green-500 transition-colors duration-300 text-xl">
                            <i class="fa-brands fa-whatsapp"></i>
                        </a>
                    <?php endif; ?>
                    
                    <?php if($p->instagram): ?>
                        <a href="<?php echo e($p->instagram); ?>" target="_blank" class="text-gray-400 hover:text-pink-500 transition-colors duration-300 text-xl">
                            <i class="fa-brands fa-instagram"></i>
                        </a>
                    <?php endif; ?>
                    
                    <?php if($p->email): ?>
                        <button onclick="copyEmail('<?php echo e($p->email); ?>')" 
        ...
        <div id="content-sosling" class="hidden grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3 team-content">
            <?php $__currentLoopData = $sosling; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex flex-col items-center">
                <img class="object-cover w-full rounded-xl aspect-square shadow-md" 
                    src="<?php echo e(asset('storage/' . $p->image)); ?>" 
                    alt="<?php echo e($p->name); ?>">
        ...
        <div id="content-huminfo" class="hidden grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3 team-content">
            <?php $__currentLoopData = $huminfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex flex-col items-center">
                <img class="object-cover w-full rounded-xl aspect-square shadow-md" 
                    src="<?php echo e(asset('storage/' . $p->image)); ?>" 
                    alt="<?php echo e($p->name); ?>">
...
</html><?php /**PATH C:\laragon\www\UAS\resources\views/pengurus.blade.php ENDPATH**/ ?>