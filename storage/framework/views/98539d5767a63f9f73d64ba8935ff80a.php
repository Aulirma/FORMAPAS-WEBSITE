...
<body class="bg-[#f8e1ca] min-h-screen px-4 py-10 sm:py-16">
    ...
    <!-- CARD -->
        ...
        <div class="p-6 rounded-xl text-[#FF7A00] bg-[#f8e1ca] border border-orange-200">
            ...
            <div class="grid grid-cols-2 gap-x-6 gap-y-3">            
                ...
                <div class="col-span-1">
                    ...
                    <p class="font-semibold break-words">
                        <?php echo e(Auth::user()->USER_EMAIL); ?>
        ...
        <form id="passwordForm"
            method="POST"
            action="<?php echo e(route('user.update.pw')); ?>"
        ...
        <form id="emailForm"
            action="<?php echo e(route('user.update.email')); ?>"
            method="POST"
            class="hidden space-y-4 mb-8">
            <?php echo csrf_field(); ?>
        ...
        <!-- CUSTOMER SERVICE -->
        <a href="https://wa.me/628XXXXXXXXX?text=Halo%20Admin,%20saya%20<?php echo e(Auth::user()->USER_NAME); ?>%20ingin%20bertanya."
            target="_blank"
...
<?php /**PATH C:\laragon\www\UAS\resources\views/user/setting.blade.php ENDPATH**/ ?>