...
<body class="flex items-center justify-center min-h-screen">
    <div class="relative bg-white p-8 rounded-2xl shadow-xl w-96">
        <a href="<?php echo e(route('auth')); ?>" class="absolute top-4 right-4">
        ...
        <!-- =========================
                FORM LOGIN ADMIN
        ========================== -->
        <form action="<?php echo e(route('admin.login')); ?>" method="POST" class="mb-6">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\UAS\resources\views/admin/login.blade.php ENDPATH**/ ?>