...
<tr class="border-b">
    <td class="p-2"><?php echo e($p->NAMA_PRODUCT); ?></td>
    <td class="p-2"><?php echo e($p->JENIS_PRODUCT); ?></td>
    <td class="p-2">Rp <?php echo e(number_format($p->HARGA_PRODUCT,0,',','.')); ?></td>
    <td class="p-2">
        <img src="<?php echo e(asset('storage/'.$p->FOTO_PRODUCT)); ?>"
             class="h-12 rounded">
    </td>
    <td class="p-2 flex gap-2">

        <!-- DELETE -->
        <form action="<?php echo e(route('admin.merch.delete',$p->ID_PRODUCT)); ?>"
              method="POST">
            <?php echo csrf_field(); ?>
...
<form action="<?php echo e(route('admin.merch.store')); ?>" method="POST" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\UAS\resources\views/admin/merch.blade.php ENDPATH**/ ?>