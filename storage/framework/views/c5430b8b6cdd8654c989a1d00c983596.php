...
<body class="bg-[#FFF4E6]">
    ...
    <div class="max-w-3xl mx-auto mt-28 p-6 bg-white rounded-xl shadow-lg">
        ...
        <p class="mb-4">Halo, <b><?php echo e(Auth::user()->USER_NAME); ?></b> ✨</p>

        
        <?php if(Auth::user()->STATUS_KKN === 'TERDAFTAR'): ?>

            <div class="p-4 bg-green-50 border-l-4 border-green-500 rounded-lg">
                <p class="font-semibold text-green-700">Kamu sudah terdaftar KKN 🎉</p>
                <p class="text-sm text-gray-600 mt-2">
                    Data kamu sudah tersimpan dan akan diproses oleh admin FORMAPAS.
                </p>
            </div>
