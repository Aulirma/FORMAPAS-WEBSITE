...
<body class="bg-[#FFF4E6]">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start relative">
      ...
      <section id="checkout" class="hidden bg-white p-6 rounded-xl shadow border border-orange-100 animate-fade-in">
        ...
        <div class="mb-3">
          ...
          <input id="checkoutNama" type="text" class="w-full p-3 border border-gray-200 rounded-xl focus:outline-none focus:border-orange-500 <?php echo e(Auth::check() ? 'bg-gray-100 text-gray-500 cursor-not-allowed' : ''); ?>" 
            placeholder="Nama Lengkap" value="<?php echo e(Auth::check() ? Auth::user()->USER_NAME : ''); ?>" <?php echo e(Auth::check() ? 'readonly' : ''); ?>
        ...
        <div class="mb-4">
          ...
          <input id="checkoutHp" type="text" class="w-full p-3 border border-gray-200 rounded-xl focus:outline-none focus:border-orange-500" 
            placeholder="Contoh: 08123456789" value="<?php echo e(Auth::check() ? Auth::user()->NO_HP : ''); ?>"
          >
        </div>
  ...
  </main>  <?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
const dbProducts = <?php echo json_encode($products
    ...
    const ASSET_URL = "<?php echo e(asset('images')); ?>";
    const products = [
      { id: 101, title: "FORMAPAS T-Shirt", cat: "Clothing", price: 75000, image: "<?php echo e(asset('images/kaosputih.png')); ?>" },
      { id: 102, title: "Sunset Hoodie", cat: "Clothing", price: 150000, image: "<?php echo e(asset('images/hodie.png')); ?>" },
      { id: 103, title: "Canvas Tote Bag", cat: "Accessories", price: 50000, image: "<?php echo e(asset('images/tas.png')); ?>" },
      { id: 104, title: "Sticker Pack", cat: "Stationery", price: 15000, image: "<?php echo e(asset('images/sticker.png')); ?>" },
      { id: 105, title: "Baseball Cap", cat: "Accessories", price: 60000, image: "<?php echo e(asset('images/topi.png')); ?>" },
      { id: 106, title: "Water Bottle", cat: "Accessories", price: 40000, image: "<?php echo e(asset('images/botol.png')); ?>" },
      { id: 107, title: "FORMAPAS Jacket", cat: "Clothing", price: 180000, image: "<?php echo e(asset('images/bajuoren.png')); ?>" },
      { id: 108, title: "Notebook FORMAS", cat: "Stationery", price: 25000, image: "<?php echo e(asset('images/notebook.png')); ?>" }    ];
  let cart=[];
...
</html><?php /**PATH C:\laragon\www\UAS\resources\views/merch.blade.php ENDPATH**/ ?>