...
<body class="bg-[#FFF4E6] text-gray-800">
    ...
    <section class="max-w-4xl mx-auto px-6 py-16 pt-24">
        <div class="text-center mb-16">
            ...
            <p class="text-gray-500">Halo, <strong><?php echo e($user->USER_NAME); ?></strong>! Pantau progres seleksimu di sini.</p>
        </div>
        ...
        <div class="relative">
            ...
            <div id="step-1" class="relative flex flex-col md:flex-row gap-8 mb-12">
                <div class="flex-shrink-0 relative z-10 md:mx-0 mx-auto">
                    <div class="flex items-center justify-center w-16 h-16 rounded-full <?php echo e($s1_done ? 'bg-green-100' : 'bg-orange-600'); ?> border-4 border-white shadow-lg transition-all">
                        <?php echo $s1_icon; ?>

                    </div>
                </div>
                <div class="flex-grow <?php echo e($s1_done ? 'bg-white border-green-200' : 'bg-white border-orange-600'); ?> p-6 rounded-2xl shadow-lg border-l-4 transition-all">
                    <div class="flex justify-between items-start mb-2">
                        <h3 class="text-xl font-bold <?php echo e($s1_done ? 'text-green-700' : 'text-orange-600'); ?>">Administrasi Berkas</h3>
                        <span class="px-3 py-1 text-xs font-semibold rounded-full <?php echo e($s1_done ? 'bg-green-100 text-green-700' : 'bg-orange-100 text-orange-700'); ?>">
                            <?php echo e(ucfirst($seleksi->status_tahap_1 ?? 'Belum Mengisi')); ?>

                        </span>
                    </div>
                    
                    <?php if($seleksi->status_tahap_1 == 'menunggu'): ?>
                        <p class="text-gray-600 text-sm">Data terkirim. Menunggu verifikasi Admin via WhatsApp.</p>
                    <?php elseif($seleksi->status_tahap_1 == 'lolos'): ?>
            ...
            <div id="step-2" class="relative flex flex-col md:flex-row gap-8 mb-12 <?php echo e($s2_open ? '' : 'opacity-50 grayscale'); ?>">
                <div class="flex-shrink-0 relative z-10 md:mx-0 mx-auto">
                    <div class="flex items-center justify-center w-16 h-16 rounded-full <?php echo e($s2_done ? 'bg-green-100' : ($s2_open ? 'bg-orange-600' : 'bg-gray-200')); ?> border-4 border-white shadow-md transition-all">
                        <?php if($s2_done): ?> <i class="fa-solid fa-check text-green-600 text-xl"></i>
                        <?php elseif($s2_open): ?> <span class="text-white font-bold text-xl">2</span>
                        <?php else: ?> <i class="fa-solid fa-lock text-gray-500 text-xl"></i> <?php endif; ?>
                    </div>
                </div>
                <div class="flex-grow bg-white p-6 rounded-2xl border-l-4 <?php echo e($s2_done ? 'border-green-200' : ($s2_open ? 'border-orange-600 shadow-lg' : 'border-gray-200 border-dashed')); ?> transition-all">
                    <div class="flex justify-between items-start mb-2">
                        <h3 class="text-xl font-bold <?php echo e($s2_done ? 'text-green-700' : ($s2_open ? 'text-orange-600' : 'text-gray-600')); ?>">Penulisan Essay</h3>
                        <span class="px-3 py-1 text-xs font-semibold rounded-full bg-gray-100 text-gray-500">
                            <?php echo e(ucfirst($seleksi->status_tahap_2)); ?>
                    ...
                    <?php elseif($seleksi->status_tahap_2 == 'menunggu'): ?>
                        <p class="text-gray-600 text-sm">Essay terkirim. Menunggu penilaian Admin.</p>
                    <?php elseif($seleksi->status_tahap_2 == 'lolos'): ?>
            ...
            ?>
            <div id="step-3" class="relative flex flex-col md:flex-row gap-8 mb-12 <?php echo e($s3_open ? '' : 'opacity-50 grayscale'); ?>">
                 <div class="flex-shrink-0 relative z-10 md:mx-0 mx-auto">
                    <div class="flex items-center justify-center w-16 h-16 rounded-full <?php echo e($s3_done ? 'bg-green-100' : ($s3_open ? 'bg-orange-600' : 'bg-gray-200')); ?> border-4 border-white shadow-md transition-all">
                        <?php if($s3_done): ?> <i class="fa-solid fa-check text-green-600 text-xl"></i>
                        <?php elseif($s3_open): ?> <i class="fa-solid fa-video text-white text-xl"></i>
                        <?php else: ?> <i class="fa-solid fa-lock text-gray-500 text-xl"></i> <?php endif; ?>
                    </div>
                </div>
                <div class="flex-grow bg-white p-6 rounded-2xl border-l-4 <?php echo e($s3_done ? 'border-green-200' : ($s3_open ? 'border-orange-600 shadow-lg' : 'border-gray-200 border-dashed')); ?>">
                    <h3 class="text-xl font-bold mb-2 <?php echo e($s3_open ? 'text-gray-800' : 'text-gray-500'); ?>">Wawancara</h3>
            ...
            ?>
            <div id="step-4" class="relative flex flex-col md:flex-row gap-8 mb-12 <?php echo e($s4_open ? '' : 'opacity-50 grayscale'); ?>">
                <div class="flex-shrink-0 relative z-10 md:mx-0 mx-auto">
                    <div class="flex items-center justify-center w-16 h-16 rounded-full <?php echo e($is_lulus ? 'bg-green-600' : 'bg-orange-600'); ?> border-4 border-white shadow-lg">
                ...
                <div class="flex-grow bg-white p-6 rounded-2xl border-l-4 border-orange-600 shadow-lg">
                    ...
                    <?php if($seleksi->status_final == 'menunggu'): ?>
                        <?php if($s4_open): ?>
    ...
    <div id="modal-administrasi" class="modal modal-inactive fixed inset-0 z-[2000] w-full h-full flex items-center justify-center bg-gray-900 bg-opacity-50 backdrop-blur-sm px-4">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 relative">
            ...
            <form action="<?php echo e(route('seleksi.tahap1')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="space-y-4">
                    <div>
    ...
    <div id="modal-essay" class="modal modal-inactive fixed inset-0 z-[2000] w-full h-full flex items-center justify-center bg-gray-900 bg-opacity-50 backdrop-blur-sm px-4">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 relative">
            ...
            <form action="<?php echo e(route('seleksi.tahap2')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="space-y-4">
                    <div>
    ...
    <div id="modal-wawancara" class="modal modal-inactive fixed inset-0 z-[2000] w-full h-full flex items-center justify-center bg-gray-900 bg-opacity-50 backdrop-blur-sm px-4">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 relative text-center">
            ...
            <form action="<?php echo e(route('seleksi.tahap3')); ?>" method="POST">
                <?php echo csrf_field(); ?>
    ...
    <div id="modal-pengumuman" class="modal modal-inactive fixed inset-0 z-[2000] w-full h-full flex items-center justify-center bg-gray-900 bg-opacity-70 backdrop-blur-sm px-4">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 relative text-center transform scale-90 transition-transform duration-300" id="announcement-card">
            ...
            <div id="result-content">
                <?php if($seleksi->status_final == 'lulus'): ?>
                ...
                <?php elseif($seleksi->status_final == 'tidak_lulus'): ?>
...
</html><?php /**PATH C:\laragon\www\UAS\resources\views/user/Seleksi.blade.php ENDPATH**/ ?>