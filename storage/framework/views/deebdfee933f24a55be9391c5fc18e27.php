...
>
    <div class="max-w-[1200px] mx-auto px-5 flex items-center">
        ...
        <div class="flex items-center gap-3 min-w-[200px]">
            <img src="<?php echo e(asset('images/Formapas Logo.png')); ?>" alt="Logo" class="w-10 h-auto">
        ...
        <nav class="flex-1 hidden md:flex justify-center">
            <ul class="flex gap-6">
                ...
                <li>
                    <a href="<?php echo e(route('toko')); ?>" id="toko"
                       class="nav-link text-[#333] font-medium text-[15px] py-2 px-4 rounded-lg hover:text-[#ff9336] transition">
                       Toko
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('pengurus')); ?>" id="pengurus"
                       class="nav-link text-[#333] font-medium text-[15px] py-2 px-4 rounded-lg hover:text-[#ff9336] transition">
                       Pengurus
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('kkn')); ?>" id="kkn"
                       class="nav-link text-[#333] font-medium text-[15px] py-2 px-4 rounded-lg hover:text-[#ff9336] transition">
                       KKN
                    </a>
                </li>
        ...
        <div class="flex items-center gap-4 min-w-[200px] justify-end">
            ...
            <?php if(auth()->guard()->guest()): ?>
                <!-- Jika belum login -->
                <a href="<?php echo e(route('auth', ['action' => 'register'])); ?>" 
            ...
            <!-- Jika sudah login -->
                <div class="relative hidden md:flex items-center gap-3">
                    <button id="profileButton"
                        ...
                        Hi, <?php echo e(Auth::user()->USER_NAME ?? 'User'); ?>
                    ...
                    <div id="profileMenu" class="hidden absolute top-full right-0 mt-2 w-64 bg-white shadow-xl border rounded-xl p-4 z-50 transition">
                        <div class="flex items-center gap-3 mb-3">
                            ...
                            <div>
                                <p class="font-semibold text-gray-800"><?php echo e(Auth::user()->USER_NAME); ?></p>
                                <p class="text-gray-500 text-sm"><?php echo e(Auth::user()->USER_EMAIL); ?></p>
                            </div>
                        </div>

                        <hr class="my-3">

                        <a href="<?php echo e(route('user.setting')); ?>" class="block text-gray-700 hover:text-[#db5400] px-1 py-1">✏ Setting Akun</a>
                        <a href="<?php echo e(route('user.daftar')); ?>" class="block text-gray-700 hover:text-red-600 px-1 py-1">🏃‍♀️ Status KKN</a>
                        <a href="<?php echo e(route('user.merch')); ?>" class="block text-gray-700 hover:text-red-600 px-1 py-1">🛒 Status Merchandise</a>
...
</script><?php /**PATH C:\laragon\www\UAS\resources\views/header.blade.php ENDPATH**/ ?>