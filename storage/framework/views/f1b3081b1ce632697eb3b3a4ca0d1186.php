...
<body class="bg-[#FFF4E6] text-gray-800">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 items-center gap-6 px-6 mt-20 pt-24 pb-16">
        ...
        <div class="flex flex-col justify-center px-4 sm:px-0">
            ...
            <a href="<?php echo e(route('kkn')); ?>" class="bg-[#db5400] text-white px-5 py-3 rounded-lg shadow-md hover:shadow-lg hover:bg-[#e87c09cc] transition w-max">
        ...
        <div id="news" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="news-card bg-[#FFF4E6] rounded-2xl shadow-md hover:shadow-lg hover:shadow-[#FF7A00]/50 transition overflow-hidden">
                    <img src="<?php echo e(asset('storage/'.$item->FOTO_NEWS)); ?>"
                        class="w-full h-48 object-cover">

                    <div class="p-5 text-left">
                        <h3 class="text-xl font-bold mb-2 text-[#db5400]">
                            <?php echo e($item->JUDUL_NEWS); ?>

                        </h3>

                        <p class="text-sm text-gray-500 mb-3">
                            <?php echo e($item->LOKASI_NEWS); ?>

                        </p>

                        <p class="text-gray-700 text-sm line-clamp-3">
                            <?php echo e($item->ISI_NEWS); ?>

                        </p>

                        <button
                            class="mt-3 px-4 py-2 bg-[#ffa552] text-white rounded-lg shadow hover:bg-[#ff7a00] transition readMoreBtn"
                            data-title="<?php echo e($item->JUDUL_NEWS); ?>"
                            data-img="<?php echo e(asset('storage/'.$item->FOTO_NEWS)); ?>"
                            data-date="<?php echo e($item->LOKASI_NEWS); ?>"
                            data-content="<?php echo e($item->ISI_NEWS); ?>"
                        >
                            Read More
                        </button>
                    </div>
...
<?php /**PATH C:\laragon\www\UAS\resources\views/index.blade.php ENDPATH**/ ?>